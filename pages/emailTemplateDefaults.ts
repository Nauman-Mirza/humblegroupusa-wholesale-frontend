  ...
  <tr>
    <td align="center" valign="top">
      <table width="600" cellpadding="0" cellspacing="0" border="0"
        ...
        <!-- Accent bar -->
        <tr>
          <td style="background-color:#334155;height:3px;font-size:0;line-height:0">&nbsp;</td>
        </tr>
        ...
        <tr>
          <td style="background-color:#0f172a;padding:28px 48px;border-radius:0 0 12px 12px;text-align:center">
            <p style="color:#64748b;margin:0 0 6px;font-size:12px;line-height:1.6">
              &copy; 2025 <strong style="color:#94a3b8">Humble Group USA</strong>. All rights reserved.
            </p>
...
const detailRow = (label: string, value: string) => `
  <tr>
    <td style="padding:8px 0;border-bottom:1px solid #f1f5f9;width:40%;vertical-align:top">
...
const alertBox = (bg: string, borderColor: string, iconColor: string, icon: string, text: string) => `
  <table width="100%" cellpadding="0" cellspacing="0" border="0"
...
const stepRow = (icon: string, title: string, desc: string, done: boolean) => `
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:16px">
    <tr>
      <td style="vertical-align:top;width:36px">
        <div style="width:32px;height:32px;border-radius:50%;background-color:${done ? '#0f172a' : '#e2e8f0'};
          color:${done ? '#ffffff' : '#94a3b8'};text-align:center;line-height:32px;font-size:14px">
          ${done ? icon : '○'}
        </div>
      </td>
      <td style="padding-left:14px;vertical-align:middle">
        <p style="margin:0 0 2px;font-size:13px;font-weight:700;color:${done ? '#0f172a' : '#94a3b8'}">${title}</p>
        <p style="margin:0;font-size:12px;color:#94a3b8;line-height:1.4">${desc}</p>
      </td>
    </tr>
  </table>`;

export const EMAIL_TEMPLATE_DEFAULTS: Record<string, { subject: string; body_html: string; body_text: string }> = {

  new_user_registration_notification: {
    subject: 'New Registration Request — {{first_name}} {{last_name}}',
    body_html: emailWrapper(`
      <h1 style="margin:0 0 6px;font-size:24px;font-weight:800;color:#0f172a">New Registration Request</h1>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:36px">
        <tr><td align="center">
          <p style="margin:0 0 14px;font-size:12px;color:#94a3b8;text-transform:uppercase;letter-spacing:2px">Action Required</p>
  ...
  order_created_user: {
    ...
    body_html: emailWrapper(`
      <p style="margin:0 0 4px;font-size:13px;color:#64748b;text-transform:uppercase;letter-spacing:2px;font-weight:700">Order Confirmation</p>
      <h1 style="margin:0 0 8px;font-size:28px;font-weight:800;color:#0f172a">Thank you, {{first_name}}!</h1>
      <p style="margin:0 0 32px;font-size:14px;color:#64748b;line-height:1.6">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
              <td colspan="2" style="padding-top:16px;border-top:1px solid #e2e8f0">
                <p style="margin:0;font-size:12px;color:#94a3b8"><strong style="color:#64748b">{{items_count}}</strong> item(s) ordered</p>
              </td>
            </tr>
          </table>
        </td></tr>
      ...
      <p style="margin:24px 0 0;font-size:14px;color:#0f172a;line-height:1.6">
        Best regards,<br><strong>The Humble Group USA Team</strong>
      </p>
    `),
  ...
  registration_accepted: {
    ...
    body_html: emailWrapper(`
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px">
        ${[
          ...
          ['💬', 'Contact Support',          'Our team is ready to help with any questions about products or ordering.'],
        ].map(([icon, title, desc]) => `
          <tr>
    ...
    `),
    body_text: 'Hello {{first_name}}, your registration for {{company_name}} has been approved. Your account is now active and you can start placing wholesale orders.',
  },
  ...
  registration_declined: {
    ...
    body_html: emailWrapper(`
      ...
      <h1 style="margin:0 0 8px;font-size:26px;font-weight:800;color:#0f172a;text-align:center">Hello, {{first_name}}</h1>
      ...
      ${alertBox('#fff7ed','#f97316','#ea580c','⚠',
        'After careful review, we are unable to approve your registration request at this time. This may be based on current business requirements, coverage area, or other internal criteria.'
      )}
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px">
        <tr>
          ...
          <td style="padding:12px 0 12px 12px;border-bottom:1px solid #f1f5f9">
            <p style="margin:0 0 2px;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#94a3b8">Email Us</p>
            <p style="margin:0;font-size:14px;color:#0f172a">support@humblegroupusa.com</p>
          </td>
        </tr>
      </table>
    ...
    `),
    body_text: 'Hello {{first_name}}, thank you for your interest in Humble Group USA. After review, we are unable to approve your registration at this time. Please contact support@humblegroupusa.com if you have questions.',
  },

  user_registration_thank_you: {
    subject: 'We Received Your Registration — Humble Group USA',
    body_html: emailWrapper(`
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px">
        <tr><td align="center">
          <div style="width:64px;height:64px;background-color:#f1f5f9;border-radius:50%;display:inline-block;text-align:center;line-height:64px;font-size:28px">
            📬
          </div>
        </td></tr>
      </table>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr><td style="padding:28px 32px">
          ${stepRow('✅', 'Application Submitted', 'Your registration details have been received.', true)}
          ${stepRow('⏳', 'Under Review',           'Our team is currently reviewing your application.', true)}
          ${stepRow('📬', 'Decision Notification',  "We'll email you once a decision has been made.", false)}
        </td></tr>
      </table>
